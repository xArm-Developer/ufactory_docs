...
1. According to the documentation, verify if the joint firmware version is ≥ 4.0.18. 
   - **If version < 4.0.14:** Contact UFACTORY Technical Support for an update.
   - **If 4.0.14 ≤ version ≤ 4.0.18:** follow the guide to update the firmware. Reference: [How to check/update the joint firmware? | UFactory Docs](https://docs.supportarticle.ufactory.cc/support_articles/hardware/how-to-update-the-joint-firmware.html)
