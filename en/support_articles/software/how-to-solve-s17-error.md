...
1. According to the documentation, verify if the joint firmware version is ≥ 4.0.18. 
   - **If version < 4.0.14:** Contact UFACTORY Technical Support for an upgrade.
...
2. Launch [xarm-tool-gui](https://drive.google.com/drive/folders/19qFJlldeSs_SH1UTjnMnNToeXC-BqS-N?usp=sharing),Enter the controller IP address and click Connect.
