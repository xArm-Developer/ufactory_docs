...
### 手臂型号：Lite6、1303及以下版本

错误码：S17，关节ID：*（1~7），状态码：16，**（仅Lite6型号需关注）关节固件版本 < 4.0.18**
...
### 手臂型号：UF850、Lite6、1304及以上版本

错误码：S17，关节ID：*（1~7），状态码：16，**（仅Lite6、xArm1304型号需关注）关节固件版本 ≥ 4.0.18**

1. 按下急停，然后松开
2. 下载并运行[xarm-tool-gui](https://update.ufactory.cc/jointServo/xarm-tool-gui-2.19.8.zip)，输入控制器IP，点击连接
...
4. 切换到调试工具，选择报错的关节ID，点击清除单圈状态码16

5. 按下急停，等5秒松开急停，尝试再次使能机械臂
