...
下载最新的离线安装包： [xArm/UF850](https://update.ufactory.cc/release_note/xarmcontroller_studio-x86_64-2.8.2.zip)     [Lite6](https://update.ufactory.cc/release_note/xarmcontroller_studio-aarch64-2.8.2.zip)
...
下载 xarm-tool-gui工具，解压缩并运行。输入控制器的 IP 地址，点击【连接】按钮。

- Windows：[xarm-tool-gui](https://update.ufactory.cc/firmware_studio/xarm-tool-gui-2.19.8.zip)
- Linux：[xarm-tool-gui](https://update.ufactory.cc/firmware_studio/xarm-tool-gui-linux-2.19.8.zip)
